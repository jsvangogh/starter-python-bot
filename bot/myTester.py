...
make_hist(df, raw_input("Which column?: "))

# while True:
# 	kind = raw_input("What type of chart do you want?: ")
# 	axis_x = raw_input("What should be the x axis?: ")
# 	axis_y = raw_input("What should be the y axis?: ")

# 	dfplot = df.plot(kind=kind, x=axis_x, y=axis_y)
# 	fig = dfplot.get_figure()
# 	plt.show()
